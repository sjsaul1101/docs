...
description: "On-Chain Brews are pixel-art beers, permanently stored on Ethereum and released one at a time through Dutch auctions lasting 420 blocks. Each new brew adds to the growing collection, and along the way a built-in randomness system occasionally unlocks surprise rewards.
"
---
