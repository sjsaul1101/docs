...
<Info>
  Currently, there is a bot processing claims automatically, but as an on-chain fallback, anyone can call the "claim" function and trigger the distribution of rewards within the 256-block window.
</Info>
